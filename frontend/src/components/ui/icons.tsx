...
export const BrandIcon: React.FC<IconProps> = ({ className = "", size = 20 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const UserCheckIcon: React.FC<IconProps> = ({ className = "", size = 20 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const MagnetIcon: React.FC<IconProps> = ({ className = "", size = 20 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M6 15h4v5a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1v-5z"/>
    <path d="M14 15h4v5a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-5z"/>
    <path d="M6 15V9a6 6 0 0 1 12 0v6"/>
    <path d="M6 9V4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v5"/>
    <path d="M14 9V4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v5"/>
  </svg>
);
...
export const LayoutIcon: React.FC<IconProps> = ({ className = "", size = 20 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">

...
import ModernLoginForm from './ModernLoginForm.tsx';

export default function ModernLoginPage() {
  // Hydration hatasını önlemek için useState'i kaldırdık
  return (
          ...
          <div className="max-w-md">
            ...
            <div className="mb-8 flex justify-center">
              <img 
                ...
                onError={(e) => {
                  // Fallback: Eğer logo.png yoksa logo.svg dene
            ...
            <h1 className="text-4xl font-bold leading-tight">
              Raporlama Portalına
              <span className="block text-blue-200">Hoş Geldiniz</span>
            </h1>
          </div>
        </div>
